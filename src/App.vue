        ...
        <div
            ...
            <template v-if="watchState.isLoggedIn">
                <div class="main-app-layout">
                    ...
                    <el-splitter class="modern-splitter" @resize-end="setAsideWidth">
                        <el-splitter-panel class="main-content-panel">
                            <RouterView></RouterView>
                        </el-splitter-panel>

                        <el-splitter-panel v-if="isSideBarTabShow" :min="280" :max="700" :size="asideWidth" collapsible class="sidebar-panel">
                            <Sidebar></Sidebar>
                        </el-splitter-panel>
                    </el-splitter>
                </div>
...
<style lang="scss" scoped>
    ...
    :deep(.modern-splitter) {
        flex: 1;
        height: 100%;
        
        .el-splitter__wrapper {
            height: 100%;
        }
