...
export const useVrcxStore = defineStore('Vrcx', () => {
    ...
    async function updateDatabaseVersion() {
        ...
        // Skip if userPrefix is not set (user not logged in yet)
        const { dbVars } = await import('../service/database');
        if (!dbVars.userPrefix) {
            console.log('Skipping database update: user not logged in yet');
            return;
        }
