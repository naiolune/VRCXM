...
import { analyticsCache } from './database/analyticsCache.js';
...
import { hiddenFriends } from './database/hiddenFriends.js';
...
const database = {
    ...
    async initUserTables(userId) {
        ...
        await sqliteService.executeNonQuery(
            `CREATE TABLE IF NOT EXISTS ${dbVars.userPrefix}_hidden_friends (user_id TEXT PRIMARY KEY, hidden_at TEXT)`
        );
        await analyticsCache.initTables();
    },
