...
function setLoginContainerStyle(isDarkMode) {
    ...
    const backgroundColor = isDarkMode ? '#000000' : '#ffffff'; // Pure black for dark mode
    const inputBackgroundColor = isDarkMode ? 'rgba(255, 255, 255, 0.05)' : '#ffffff';
    const inputBorder = isDarkMode ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #DCDFE6';
