<template>
    <div class="activity-detail-container">
        ...
        <div ref="activityDetailChartRef" class="activity-detail-chart"></div>
    </div>
</template>
            ...
            return `
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <div style="line-height: 1.6;">
                            <div style="font-weight: 600; color: rgba(255, 255, 255, 0.95); margin-bottom: 4px;">${instanceData.display_name} ${friendOrFavIcon(instanceData.display_name)}</div>
...
<style scoped lang="scss">
    ...
    .dark .activity-detail-container {
    ...
    html:not(.dark) .activity-detail-container {
        background: #f5f5f5;
