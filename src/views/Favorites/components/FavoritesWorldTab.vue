    ...
    <div class="favorites-tab-content">
        <div class="tab-toolbar">
            <div class="toolbar-left">
                ...
                <el-button size="small" @click="showWorldImportDialog">
        ...
        <div v-if="worldFavoriteSearchResults.length" class="search-results-section">
                ...
                <div
                    ...
                    <div class="result-content">
                        ...
                        <div class="result-meta">
                            <span v-if="favorite.authorName" v-text="favorite.authorName"></span>
                            <span v-if="favorite.occupants" class="result-badge">{{ favorite.occupants }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="favorites-section">
            <h3 class="section-title">{{ t('view.favorite.worlds.vrchat_favorites') }}</h3>
            <el-collapse class="modern-collapse">
                <el-collapse-item 
                        ...
                        <div class="collapse-title">
                            ...
                            <div class="group-actions" @click.stop>
                                <el-tooltip
                                    ...
                                    :teleported="false">
                                    <el-dropdown trigger="click" size="small" :persistent="false">
                                        <el-button type="default" :icon="View" size="small" circle class="group-action-btn" @click.stop />
                                        <template #dropdown>
                                            <el-dropdown-menu>
                    ...
                    <div v-if="group.count" class="group-items-scroll">
                        <el-scrollbar height="500px" @end-reached="worldFavoritesLoadMore">
        ...
        <div class="favorites-section">
            <div class="section-header">
                <h3 class="section-title">{{ t('view.favorite.worlds.local_favorites') }}</h3>
                <div class="section-actions">
                    ...
                    <el-button v-else size="small" @click="cancelLocalWorldRefresh">
                    ...
                    <template #title>
                        <div class="collapse-title">
                            <div class="group-info">
                                ...
                                <span class="group-count">{{ localWorldFavGroupLength(group) }}</span>
                            </div>
                            <div class="group-actions" @click.stop>
                                <el-tooltip placement="top" :content="t('view.favorite.rename_tooltip')" :teleported="false">
                                    <el-button
                                        ...
                                        circle
                                        class="group-action-btn"
                                        @click="promptLocalWorldFavoriteGroupRename(group)" />
                                </el-tooltip>
                                <el-tooltip placement="right" :content="t('view.favorite.delete_tooltip')" :teleported="false">
                                    <el-button
                                        ...
                                        circle
                                        class="group-action-btn"
                                        @click="promptLocalWorldFavoriteGroupDelete(group)" />
                                </el-tooltip>
                            </div>
                        </div>
                    </template>
                    <div v-if="localWorldFavorites[group].length" class="group-items-scroll">
                        <el-scrollbar height="500px" @end-reached="localWorldFavoritesLoadMore">
                            <div class="group-items">
...
<style scoped lang="scss">
    ...
    // Dark theme result badge
    .dark .result-badge {
        background: rgba(255, 255, 255, 0.06);
    }

    // Light theme result badge
    html:not(.dark) .result-badge {
        background: #f0f0f0;
    }
