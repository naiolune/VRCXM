...
**Fork [VRCX](https://github.com/vrcx-team/VRCX) z nowoczesnym ciemnym motywem i ulepszonymi funkcjami.**
...
**Uwaga:** To tłumaczenie może nie być aktualne. Sprawdź [wersję angielską](/README.md) dla najnowszych informacji, szczególnie dotyczących migracji z VRCX.

VRCXM to fork VRCX, aplikacji pomocniczej dla VRChat, która dostarcza informacje i pomoc w różnorodnych czynnościach związanych z VRChat, w wygodniejszy sposób niż klient gry (PC i VR) czy strona internetowa. Ten fork zawiera pełny redesign z nowoczesnym ciemnym motywem i dodatkowymi funkcjami, zachowując funkcjonalność 1:1 z oryginalnym VRCX.

# Pierwsze kroki

<div align="center">

**Uwaga:** VRCXM to fork i musi być zbudowany ze źródeł. Zobacz [Budowanie ze źródeł](#budowanie-ze-źródeł) poniżej.

Oryginalny instalator VRCX (`VRCX_Setup.exe`) jest dostępny [stąd](https://github.com/vrcx-team/VRCX/releases/latest).
...
VRCXM musi być zbudowany ze źródeł. Zobacz oryginalny przewodnik VRCX [Budowanie ze źródeł](https://github.com/vrcx-team/VRCX/wiki/Building-from-source) po instrukcje. Proces budowania jest identyczny jak VRCX.

## Migracja z VRCX

VRCXM używa oddzielnego folderu danych (`VRCXM`) aby uniknąć konfliktów z oryginalnym VRCX. Jeśli chcesz przenieść istniejące dane VRCX (znajomi, historia feed, ulubione itp.) do VRCXM, zobacz [angielską wersję README](/README.md#migrating-from-vrcx) po szczegółowe instrukcje.

## Różnice w stosunku do VRCX

- **Nowoczesny Ciemny Motyw**: Pełny redesign wizualny z piękną ciemną estetyką
- **Zaawansowane Filtry Feed**: Filtrowanie według zakresu dat i ulepszone filtry tagów/typów dla feedu aktywności
- **Ukryj Znajomych z Feedu**: Opcja ukrycia konkretnych znajomych z feedu aktywności przy jednoczesnym śledzeniu ich danych
- **Panel Analityczny**: Kompleksowa strona analityki z:
  - Analityka Aktywności: Podział czasu na światy/avatary
  - Statystyki Społeczne: Ranking najbardziej aktywnych znajomych
  - Analityka Światów i Avatarów: Najczęściej odwiedzane światy i statystyki użycia avatarów
- **Ustawienia Wydajności**: Konfigurowalny maksymalny rozmiar tabeli dla zapytań feedu i dziennika gry
- **Oddzielne Dane Aplikacji**: Używa folderu `VRCXM` zamiast `VRCX`
- **Wszystkie oryginalne funkcje VRCX zachowane**: Funkcjonalność 1:1 z oryginałem

## Opiekun

VRCXM jest utrzymywany przez [naiolune](https://github.com/naiolune).

Oryginalny VRCX jest rozwijany przez [pypy](https://github.com/pypy-vrc) i [Natsumi](https://github.com/Natsumi-sama).

## Zasoby Oryginalnego VRCX
...
## Czy VRCXM łamie TOS VRChatu?

**Nie.**

VRCXM (podobnie jak VRCX) to zewnętrzne narzędzie, które używa API VRChatu do oferowania swoich funkcji.
...
VRCXM nie jest wspierany przez VRChat i nie odzwierciedla poglądów ani opinii VRChat lub kogokolwiek oficjalnie zaangażowanego w produkcję lub zarządzanie własnoścami VRChatu. VRChat i wszystkie powiązane właściwości są znakami towarowymi lub zastrzeżonymi znakami towarowymi VRChat Inc. VRChat © VRChat Inc.

VRCXM to fork [VRCX](https://github.com/vrcx-team/VRCX) i nie jest powiązany z zespołem VRCX.
