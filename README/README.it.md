...
**Un fork di [VRCX](https://github.com/vrcx-team/VRCX) con tema scuro moderno e funzionalità migliorate.**
...
**Nota:** Questa traduzione potrebbe non essere aggiornata. Consulta la [versione in inglese](/README.md) per le informazioni più recenti, in particolare sulla migrazione da VRCX.

VRCXM è un fork di VRCX, un'applicazione di assistenza/accompagnamento per VRChat che fornisce informazioni e aiuta a compiere varie operazioni relative a VRChat in modo più conveniente rispetto all'uso del solo client VRChat (desktop o VR) o del sito web. Questo fork presenta una riprogettazione completa con un tema scuro moderno e funzionalità aggiuntive mantenendo una funzionalità 1:1 con il VRCX originale.

# Per Iniziare

<div align="center">

**Nota:** VRCXM è un fork e deve essere compilato dal codice sorgente. Consulta [Compilazione dal codice sorgente](#compilazione-dal-codice-sorgente) di seguito.

L'installer VRCX originale (`VRCX_Setup.exe`) è disponibile [qui](https://github.com/vrcx-team/VRCX/releases/latest).
...
VRCXM deve essere compilato dal codice sorgente. Consulta la guida originale di VRCX [Compilazione dal codice sorgente](https://github.com/vrcx-team/VRCX/wiki/Building-from-source) per le istruzioni. Il processo di compilazione è identico a VRCX.

## Migrazione da VRCX

VRCXM utilizza una cartella dati separata (`VRCXM`) per evitare conflitti con il VRCX originale. Se desideri migrare i tuoi dati VRCX esistenti (amici, cronologia feed, preferiti, ecc.) a VRCXM, consulta la [versione in inglese del README](/README.md#migrating-from-vrcx) per le istruzioni dettagliate.

## Differenze rispetto a VRCX

- **Tema Scuro Moderno**: Riprogettazione visiva completa con un'estetica scura moderna
- **Filtri Feed Avanzati**: Filtraggio per intervallo di date e filtri tag/tipo migliorati per il feed delle attività
- **Nascondi Amici dal Feed**: Opzione per nascondere amici specifici dal feed delle attività continuando a tracciare i loro dati
- **Dashboard Analitica**: Pagina di analisi completa con:
  - Analisi Attività: Suddivisione del tempo per mondo/avatar
  - Statistiche Sociali: Classifica degli amici più attivi
  - Analisi Mondo e Avatar: Mondi più visitati e statistiche di utilizzo degli avatar
- **Impostazioni Prestazioni**: Dimensione massima tabella configurabile per le query di feed e log di gioco
- **Dati Applicazione Separati**: Utilizza la cartella `VRCXM` invece di `VRCX`
- **Tutte le funzionalità VRCX originali preservate**: Parità funzionale 1:1 con l'originale

## Manutentore

VRCXM è mantenuto da [naiolune](https://github.com/naiolune).

Il VRCX originale è sviluppato da [pypy](https://github.com/pypy-vrc) e [Natsumi](https://github.com/Natsumi-sama).

## Risorse VRCX Originale
...
## VRCXM è contro i TOS di VRChat?

**No.**

VRCXM (come VRCX) è uno strumento esterno che utilizza l'API di VRChat per fornire le sue funzioni.
...
VRCXM non è approvato da VRChat e non riflette i punti di vista o le opinioni di VRChat o di chiunque sia ufficialmente coinvolto nella produzione o nella gestione delle proprietà di VRChat. VRChat e tutte le proprietà associate sono marchi o marchi registrati di VRChat Inc. VRChat © VRChat Inc.

VRCXM è un fork di [VRCX](https://github.com/vrcx-team/VRCX) e non è affiliato al team VRCX.
