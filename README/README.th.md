...
**Fork ของ [VRCX](https://github.com/vrcx-team/VRCX) พร้อมธีมมืดที่ทันสมัยและฟีเจอร์ที่ปรับปรุงแล้ว**
...
**หมายเหตุ:** การแปลนี้อาจไม่เป็นเวอร์ชันล่าสุด โปรดดู[เวอร์ชันภาษาอังกฤษ](/README.md) สำหรับข้อมูลล่าสุด โดยเฉพาะเกี่ยวกับการย้ายข้อมูลจาก VRCX

VRCXM เป็น fork ของ VRCX ซึ่งเป็นโปรแกรมคู่หูสำหรับ VRChat ที่จะช่วยให้คุณเข้าถึงข้อมูลต่างๆ และอำนวยความสะดวกในการทำสิ่งต่างๆ ที่เกี่ยวข้องกับ VRChat ได้ง่ายยิ่งขึ้น แทนที่จะต้องพึ่งพาแค่ตัวเกม VRChat (ทั้งเวอร์ชันเดสก์ท็อปและ VR) หรือเว็บไซต์เพียงอย่างเดียว Fork นี้มีการออกแบบใหม่ทั้งหมดพร้อมธีมมืดที่ทันสมัยและฟีเจอร์เพิ่มเติม โดยยังคงฟังก์ชันการทำงาน 1:1 กับ VRCX เดิม

# การเริ่มต้นใช้งาน

<div align="center">

**หมายเหตุ:** VRCXM เป็น fork และต้องสร้างจากซอร์สโค้ด ดู[การสร้างจากซอร์สโค้ด](#การสร้างจากซอร์สโค้ด) ด้านล่าง

ตัวติดตั้ง VRCX เดิม (`VRCX_Setup.exe`) สามารถดาวน์โหลดได้จาก [ที่นี่](https://github.com/vrcx-team/VRCX/releases/latest)
...
VRCXM ต้องสร้างจากซอร์สโค้ด ดูคู่มือ VRCX เดิม [การสร้างจากซอร์สโค้ด](https://github.com/vrcx-team/VRCX/wiki/Building-from-source) สำหรับคำแนะนำ กระบวนการสร้างเหมือนกับ VRCX

## การย้ายข้อมูลจาก VRCX

VRCXM ใช้โฟลเดอร์ข้อมูลแยก (`VRCXM`) เพื่อหลีกเลี่ยงความขัดแย้งกับ VRCX เดิม หากคุณต้องการย้ายข้อมูล VRCX ที่มีอยู่ (เพื่อน ประวัติ feed รายการโปรด ฯลฯ) ไปยัง VRCXM โปรดดู[เวอร์ชันภาษาอังกฤษของ README](/README.md#migrating-from-vrcx) สำหรับคำแนะนำโดยละเอียด

## ความแตกต่างจาก VRCX

- **ธีมมืดที่ทันสมัย**: การออกแบบใหม่ทั้งหมดด้วยสุนทรียศาสตร์มืดที่สวยงาม
- **ตัวกรอง Feed ขั้นสูง**: การกรองตามช่วงวันที่และตัวกรองแท็ก/ประเภทที่ปรับปรุงแล้วสำหรับ feed กิจกรรม
- **ซ่อนเพื่อนจาก Feed**: ตัวเลือกในการซ่อนเพื่อนเฉพาะจาก feed กิจกรรมในขณะที่ยังคงติดตามข้อมูลของพวกเขา
- **แดชบอร์ดวิเคราะห์**: หน้าวิเคราะห์ที่ครอบคลุมพร้อม:
  - วิเคราะห์กิจกรรม: แบ่งเวลาตามโลก/อวาตาร์
  - สถิติสังคม: อันดับเพื่อนที่กระตือรือร้นที่สุด
  - วิเคราะห์โลกและอวาตาร์: โลกที่เข้าชมมากที่สุดและสถิติการใช้อวาตาร์
- **การตั้งค่าประสิทธิภาพ**: ขนาดตารางสูงสุดที่กำหนดค่าได้สำหรับคำขอ feed และบันทึกเกม
- **ข้อมูลแอปพลิเคชันแยก**: ใช้โฟลเดอร์ `VRCXM` แทน `VRCX`
- **ฟังก์ชัน VRCX เดิมทั้งหมดได้รับการเก็บรักษาไว้**: ความเท่าเทียมกันของฟังก์ชัน 1:1 กับเวอร์ชันเดิม

## ผู้ดูแล

VRCXM ดูแลโดย [naiolune](https://github.com/naiolune)

VRCX เดิมพัฒนาโดย [pypy](https://github.com/pypy-vrc) และ [Natsumi](https://github.com/Natsumi-sama)
...
## VRCXM ผิดกฎ TOS ของ VRChat หรือไม่?

**ไม่**

VRCXM (เช่นเดียวกับ VRCX) เป็นเครื่องมือภายนอกที่ใช้ VRChat API เพื่อให้บริการฟีเจอร์ต่างๆ
...
VRCXM ไม่ได้รับการสนับสนุนจาก VRChat และไม่ได้แสดงความคิดเห็นแทน VRChat หรือบุคคลใดที่เกี่ยวข้องอย่างเป็นทางการในการผลิตหรือจัดการทรัพย์สินของ VRChat และทรัพย์สินที่เกี่ยวข้องทั้งหมดเป็นเครื่องหมายการค้าหรือเครื่องหมายการค้าจดทะเบียนของ VRChat Inc. VRChat © VRChat Inc.

VRCXM เป็น fork ของ [VRCX](https://github.com/vrcx-team/VRCX) และไม่เกี่ยวข้องกับทีม VRCX
